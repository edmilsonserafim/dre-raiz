-- =====================================================
-- CORREÇÃO V3: DRE RPC com UNION das 3 tabelas
-- =====================================================
-- Data: 11/02/2026
...
-- FIX V3: Campo 'date' é TEXT (não DATE) - comparação direta de strings
-- =====================================================
...
-- =====================================================
-- ✅ Campo 'date' é TEXT - comparação direta de strings
-- ✅ Sem casts (date >= p_month_from || '-01')
