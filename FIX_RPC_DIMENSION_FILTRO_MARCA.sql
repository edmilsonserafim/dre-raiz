-- =====================================================
-- CORRIGIR: getDREDimension para filtrar por marca corretamente
-- Quando expande GT, deve mostrar APENAS filiais de GT
...
-- Teste: Buscar dimensão nome_filial FILTRANDO por marca='GT'
SELECT
  dimension_value,
